-- MBC Inventory Online V1.6.1 - repair for an existing V1.6.0 database.
-- Run this file if 004_detailed_inventory_report.sql previously failed with:
-- ERROR: column locations.zone does not exist
