...
กรณีใช้รหัสผ่าน `1234` ระบบจะแปลงเป็นรหัสภายในที่ Supabase ยอมรับโดยอัตโนมัติ ผู้ใช้ Login ด้วย `1234` ได้ทันที และระบบไม่บังคับเปลี่ยนรหัสผ่าน


### อัปเกรดจากระบบที่บังคับเปลี่ยนรหัสผ่าน

รันไฟล์ต่อไปนี้หนึ่งครั้งใน Supabase SQL Editor:

```text
RUN_THIS_SQL_DISABLE_FORCE_PASSWORD_CHANGE.sql
```

ไฟล์นี้จะยกเลิกสถานะบังคับเปลี่ยนรหัสของบัญชีเดิมทั้งหมด ผู้ใช้จะ Login ด้วยรหัสล่าสุดที่ Admin กำหนดได้ทันที
